        ...
        <form onSubmit={registerUser}>
            <div className="form-container">
                <div className="input-container">
                    ...
                    <input type="text" value={reg_name} onChange={handleRegChange} placeholder='Name...' id='reg_name' />
                </div>
                <div className="input-container">
                    <label htmlFor="reg_lname">Last name</label>
                    <input type="text" value={reg_lname} onChange={handleRegChange} placeholder='Last name...' id='reg_lname' />
                </div>
                <div className="input-container">
                ...
                <div className="input-container">
                    ...
                    <input type="number" value={reg_number} onChange={handleRegChange} placeholder='Phone number...' id='reg_number' />
                </div>
                <div className="input-container">
