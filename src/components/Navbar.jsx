        ...
        <div className="container">
            <div className="nav-section">
                <div className="mobile-top-nav">
                  <BiMenu className='icon menu' onClick={() => setShowMobileSideBar(true)} />
                ...
                <div className="tablet-top-nav">
                  <BiMenu id='icon' onClick={() => setShowTabletSideBar(true)} />
                </div>
            ...
            {showMobileSideBar &&
              <div className="mobile-side-nav">
                ...
                <div className="side-nav">
                  ...
                  <GrFormClose id='close-icon' onClick={() => setShowMobileSideBar(false)} />
                  <ul>
            ...
            {showTabletSideBar &&
              <div className="tablet-side-nav">
              <div className="overlay"></div>
              <div className="side-nav">
                <h2>Auto <span>Bum.</span></h2>
                <GrFormClose id='close-icon' onClick={() => setShowTabletSideBar(false)} />
                <ul>
                  <li><Link to='/info' className='link'>Informacije</Link></li>
                  <li><Link to='/search' className='link'>Pretrage</Link></li>
                  <li><Link to={auth.currentUser && '/sell'} onClick={checkAuth} className='link'>Prodaj</Link></li>
                  {auth.currentUser && 
                    <li><Link to='/profile' id='user link' className='link'>Moj Nalog</Link></li>
                  }

                  {!auth.currentUser &&
                  <>
                    <li><Link id='login' className='link' onClick={() => handleTabClick(0)}>Prijavi se</Link></li>
                    <li><Link id='register' className='link' onClick={() => handleTabClick(1)}>Napravi novi nalog</Link></li>
                  </>
                }
                </ul> 
              </div>
