	...
	return (
		<div className="cars-container">
			<div className="cars">
				{carsData &&
					carsData.map(
						({ data: { storageImages, naslov_oglasa, godiste, gorivo, kilometraza, cijena } }, index) => (
								...
								<div className="car">
									...
									<div className="info-section">
										...
										<h3 className="mobile-h3">
											{naslov_oglasa.length > 16 ? (
												naslov_oglasa.slice(0, 16) + '...'
											) : (
												naslov_oglasa
											)}
										</h3>
										...
										<div className="mobile-attachment">
											<ul>
												<li>
													Pozovi <MdPhoneInTalk id="icon" />
												</li>
												<li>
													<AiOutlineStar id="icon" />
												</li>
												<li>
													<BsFillShareFill id="icon" />
												</li>
												<li>
													<MdMessage id="icon" />
												</li>
